...
public class BookService {
	...
	static {
		...
		books.add(new Book(102, "VB"));
	}

	@Path("/")
	@POST
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	public String create(@FormParam("id") Integer id, @FormParam("name") String name) {
	...
	@PUT
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	public String update(@FormParam("id") Integer id, @FormParam("name") String name) {
